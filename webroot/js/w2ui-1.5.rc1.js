    ...
    w2field.prototype = {
        ...
        updateOverlay: function (indexOnly) {
            ...
            if (this.type == 'time') {
                ...
                var minutes_step = this.options.minutes_step;
        ...
        */
        ...
        getMinHTML: function (hour, minutes_step) {
            if (hour == null) hour = 0;
            var options = this.options;
            if (options == null) options = { format: w2utils.settings.timeFormat };
            var h24 = (options.format.indexOf('h24') > -1);
            var tmp = [];
            for (var a = 0; a < 60; a += minutes_step) {
            ...
            var html =
                ...
                '       <td>'+ tmp[0] +'</td>' +
                '       <td>'+ tmp[1] +'</td>' +
                ((typeof(tmp[2]) != 'undefined')?'       <td>'+ tmp[2] +'</td>':'') +
                '   </tr></tbody></table></div>'+
                '</div>';
            return html;
        },
