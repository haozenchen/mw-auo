<?php
/* SVN FILE: $Id: ajax.php,v 2.4.28.1.2.1 2024/05/17 08:13:30 ashinjuang Exp $ */
/**
 ...
 * @version       $Revision: 2.4.28.1.2.1 $
 * @modifiedby    $LastChangedBy$
 * @lastmodified  $Date: 2024/05/17 08:13:30 $
 ...
 */
	function link($title, $href = null, $options = array(), $confirm = null, $escapeTitle = true) {
		...
		$htmlDefaults = array('id' => 'link' . uniqid(), 'onclick' => '');
